...
module tb_aead_core_top_std_cw; 

  // Parameters
  localparam PIPELINE_STAGES = 4;
  localparam CIPHER_ROUNDS   = 20;
  localparam RECURSION_DEPTH = 1;
  ...
  initial begin
    // Load inputs
    enc   = 1;  // encrypt
    key   = 256'h808182838485868788898A8B8C8D8E8F909192939495969798999A9B9C9D9E9F;
    ...
    // Full 64-byte plaintext from RFC (First part of the sunscreen text)
